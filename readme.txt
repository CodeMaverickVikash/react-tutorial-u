JSX (JavaScript syntax extension - JavaScript XML) - It allows you to write HTML-like code in your JavaScript files to create web contents.
...
Redux: it's a alternative of context API. Redux is a state management library for React and other JavaScript libraries. It provides a predictable and centralized way to manage the state of your application, making it easier to develop and maintain complex applications. NOTE: Similar to context API
...
Rules of hook: 1. only call Hooks inside the functional components 2. Only call Hooks on the top-level
Creating custom hook:
Redux toolkit library: it's a alternative of redux
React query (Tanstack query): It helps you to send http request to the server same as fetch or useEffect